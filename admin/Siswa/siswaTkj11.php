...
if (isset($_GET['hal'])) {
  ...
  if ($_GET['hal'] == "edit") {
    ...
    $tampil = mysqli_query($koneksi, "SELECT * FROM tsiswa11 WHERE absen = '$_GET[id]'");
    ...
    $hapus = mysqli_query($koneksi, "DELETE FROM tsiswa11 WHERE absen = '$_GET[id]'");
    //uji hapus data
    if ($hapus) {
      echo "<script>
...
<body>
  ...
  <div class="container">
    ...
    <h2 class="text-center mb-3">Data Siswa TKJ Kelas 11</h2>
    <!-- Awal row -->
    <div class="row">
      <!-- Awal col -->
      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-hover tabel-bordered">
          ...
          if (isset($_POST['bcari'])) {
            $keyword = $_POST['tcari'];
            $q = "SELECT * FROM tsiswa11 WHERE id_nis like '%$keyword%' or nama like '%$keyword%' or alamat like '%$keyword%' or absen like '%$keyword%' or kelas like '%$keyword%'order by absen asc";
          } else {
            $q = "SELECT * FROM tsiswa11 order by absen ASC";
          }
          ...
          ?>
            <tr>
              ...
              <td><?= $data['alamat'] ?></td>
              <td>
                <a href="siswaTkj11.php?hal=edit&id=<?= $data['absen'] ?>" class="btn btn-warning">Edit</a>
                <a href="siswaTkj11.php?hal=hapus&id=<?= $data['absen'] ?>" class="btn btn-danger" onclick="return confirm ('Apakah anda yakin menghapus data ini?')">Hapus</a>
              </td>
            </tr>
