    ...
    if (isset($_GET['hal']) == "edit") {
      ...
      if ($edit) {
        echo "<script>
                          ...
                          document.location='editsiswa10.php';         
                      </script>";
      } else {
        echo "<script>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">Menambah Data Guru</a>
                        <a class="collapse-item" href="cards.html">Manage Data Guru</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsesubcategory" aria-controls="collapsesubcategory">
                    <i class="fas fa-fw fa-pencil-square-o"></i>
                    <span> Sub Category</span>
                </a>
                <div id="collapsesubcategory" class="collapse" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">Add Sub Category</a>
                        <a class="collapse-item" href="cards.html">Manage Sub Category</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapspost" aria-controls="collapspost">
                    <i class="fas fa-fw fa-pencil-square-o"></i>
                    <span>Posts Berita</span>
                </a>
                <div id="collapspost" class="collapse" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">Add Posts</a>
                        <a class="collapse-item" href="cards.html">Manage Posts</a>
                        <a class="collapse-item" href="cards.html">Trash Posts</a>
                    </div>
                </div>
            </li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapscomment" aria-controls="collapscomment">
                    <i class="fas fa-fw fa-comments"></i>
                    <span>Comments</span>
                </a>
                <div id="collapscomment" class="collapse" >
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="buttons.html">Waiting for Approval</a>
                        <a class="collapse-item" href="cards.html">Approved Comments</a>
                    </div>
                </div>
            </li>
        ...
        <table class="table table-striped table-hover tabel-bordered">
          ...
          ?>
            <tr>
              ...
              <td><?= $data['alamat'] ?></td>
              <td>
                <a href="editsiswa10.php?hal=edit&id=<?= $data['absen'] ?>" class="btn btn-warning">Edit</a>
                <a href="editsiswa10.php?hal=hapus&id=<?= $data['absen'] ?>" class="btn btn-danger" onclick="return confirm ('Apakah anda yakin menghapus data ini?')">Hapus</a>
              </td>
            </tr>
          <?php endwhile; ?>
